...
BEGIN
  ...
  -- Documentos vencidos (sempre geral, independente do período de filtro)
  ...
  -- Vencendo em 30 dias (sempre geral, independente do período de filtro)
