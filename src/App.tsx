...
import DigitalCertificatesPage from "./pages/dashboard/DigitalCertificates";
        ...
        <BrowserRouter>
          <Routes>
            ...
            >
              ...
              <Route path="my-approvals" element={<WorkflowReportPage mode="approvals" />} />
              <Route path="my-signatures" element={<WorkflowReportPage mode="signatures" />} />
              ...
              <Route path="certificados" element={<DigitalCertificatesPage />} />
            </Route>
